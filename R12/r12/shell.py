...
class ShellStyle(object):
    ...
    def _label_desc(self, label, desc, label_color=''):
        ''' Generic styler for a line consisting of a label_panel and description. '''
...
class ArmShell(cmd.Cmd, object):
    ...
    def do_status(self, arg):
        ...
        max_len = len(max(list(info.keys()), key=len))
